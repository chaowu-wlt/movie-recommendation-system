...
I added the penalty term lambda to regularize the movie release year effect, like what I did to the genres effect. From Figure 2.2, we can see that regularization has minor impact on the movie release year effect. The RMSE result approves this.  
```{r echo=FALSE}
##########################################################################################################
#
